...
const pageObjects = {
  ...
  'GamesTabFirstTileHomeTeamPitcherHeadshot': getByCss('[class^="adk-grid-base"] [class^="mlb-scores-row"]:nth-child(1) [class^="mlb-scores-cell"]:nth-child(1) [class="tile-score-footer-state-players"] [class^="tile-score-pitcher"]:nth-child(1) .tile-score-pitcher-headshot'),
  'GamesTabFirstTileHomeTeamPitcherName': getByCss('[class^="adk-grid-base"] [class^="mlb-scores-row"]:nth-child(1) [class^="mlb-scores-cell"]:nth-child(1) [class="tile-score-footer-state-players"] [class^="tile-score-pitcher"]:nth-child(1) [class="tile-score-pitcher-stats-name"]'),
  'GamesTabFirstTileHomeTeamPitcherStats': getByCss('[class^="adk-grid-base"] [class^="mlb-scores-row"]:nth-child(1) [class^="mlb-scores-cell"]:nth-child(1) [class="tile-score-footer-state-players"] [class^="tile-score-pitcher"]:nth-child(1) [class="tile-score-pitcher-stats"] .tile-score-pitcher-stats-info'),
